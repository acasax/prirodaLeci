...
(function() {
    ...
    CloudflareApps.internal.markSelectors = function() { if (!currentInit) { check();
            currentInit = true;
        ...
        for (var installId in installs) {
            ...
            for (var key in selectors) {
                ...
                if (els && els.length > 1) { noteError({ type: 'init:too-many', option: key, selector: selectors[key], installId: installId });
                    initializedSelectors[hash] = true; continue; } else if (!els || !els.length) { continue; }
        ...
        try {
            ...
            switch (options.method) {
                ...
                case "before":
                    ...
                    break;
                case "replace":
                    try { id = element.cfAppsElementId = Math.random().toString(36);
