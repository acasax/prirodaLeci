...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="../images/bg-image-2-1920x754.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Odaberite proizvod</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Naručite</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Preuzmite narudžbinu</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Najlakši način do omiljenog proizvoda</p>
                </div>
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from dishes LIMIT 2"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
													
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-6 food-item product-card">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
																<div class="distance"><i class="fa fa-pin"></i>Novo</div>
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">'.$r['price'].'   RSD'.'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
