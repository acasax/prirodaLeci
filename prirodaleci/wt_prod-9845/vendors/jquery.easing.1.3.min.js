...
jQuery.extend(jQuery.easing, {
    ...
    easeInElastic: function(e, a, c, b, d) { e = 0; var f = b; if (0 == a) return c; if (1 == (a /= d)) return c + b;
        e || (e = .3 * d);
        f < Math.abs(b) ? (f = b, b = e / 4) : b = e / (2 * Math.PI) * Math.asin(b / f); return -(f * Math.pow(2, 10 * --a) * Math.sin(2 * (a * d - b) * Math.PI / e)) + c },
    ...
    easeInOutElastic: function(e, a, c, b, d) { var f = 0,
            g = b; if (0 == a) return c; if (2 == (a /= d / 2)) return c + b;
        f || (f = .3 * d * 1.5);
        g < Math.abs(b) ? (g = b, e = f / 4) : e = f / (2 * Math.PI) * Math.asin(b / g); return 1 > a ? -.5 * g * Math.pow(2, 10 * --a) * Math.sin(2 * (a * d - e) * Math.PI / f) + c : g * Math.pow(2, -10 * --a) * Math.sin(2 * (a * d - e) * Math.PI / f) * .5 + b + c },
